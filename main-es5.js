...
var LogFormComponent = /** @class */ (function () {
    ...
    LogFormComponent.prototype.uuidv4 = function () {
        //return UUID.UUID();
    ...
    LogFormComponent.ctorParameters = function () { return [
...
var LogsComponent = /** @class */ (function () {
    ...
    LogsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.logService.clearState.subscribe(function (clear) {
            if (clear) {
                _this.selectedLog = {
                    id: '',
                    text: '',
...
var LogService = /** @class */ (function () {
    ...
    LogService.prototype.setLogForm = function (log) {
    ...
    LogService.prototype.stateClear = function () {
